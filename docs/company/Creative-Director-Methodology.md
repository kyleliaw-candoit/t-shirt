...
The Creative Director determines **how that meaning becomes compelling products**.
...
Before producing creative concepts, the Creative Director should review the canonical evidence needed to understand the assignment.

Required inputs are:

1. the relevant Community Research Report,
2. the relevant Strategy Advisor assessment and portfolio recommendation,
3. the approved Brand Hypothesis Brief,
...
## 5.1 Reconstruct the Assignment

In concise form, state:

- the target identity,
- the approved brand name and positioning,
- the core identity truth,
- the recognition mechanism, tension, or worldview,
- the intended emotional response,
- the meaningful differentiation,
- the brand boundaries,
- the cultural / authenticity guardrails,
- the strategic test hypothesis,
- what must remain true in creative execution,
- what the Creative Director is free to explore.

This reconstruction should be traceable to the Brand Hypothesis Brief and upstream evidence.

## 5.2 Completeness Test

Ask whether the Brand Hypothesis Brief gives enough direction to answer:

> **What meaning are we trying to express, for whom, and what must not be lost in execution?**

A brief is sufficiently complete when the Creative Director can create distinct product hypotheses without having to decide the brand's fundamental positioning, target identity, or strategic meaning.

## 5.3 Internal-Consistency Test

Check for material contradictions such as:

- target identity conflicting with the underlying Community Research,
- positioning conflicting with stated brand boundaries,
- differentiation relying on a meaning the brief elsewhere rejects,
- intended emotional response conflicting with cultural guardrails,
- strategic test hypothesis not matching the approved positioning,
- required creative constraints making the intended brand meaning impossible to express.

The Creative Director should distinguish a genuine contradiction from ordinary creative tension. Creative tension is often useful; strategic contradiction is a blocker.

## 5.4 Sufficiency Test
...
If no, identify the smallest missing decision that blocks execution.

## 5.5 Gate 1 — Handoff Integrity
...
Minor ambiguities exist, but they do not require upstream decisions and can be explored through creative alternatives.

Proceed, while documenting the assumptions being tested.

### Blocked

A material contradiction or missing brand decision would force the Creative Director to redefine upstream strategy.

Do **not** silently solve it through creative work.

Route the issue back to the **Brand Manager**, with the founder included when the decision is strategically consequential.

A blocker report should state only:

- the contradiction or missing decision,
- why it prevents credible execution,
- the smallest decision needed to unblock work.

Do not reopen unrelated brand questions.
...
What evidence-backed truth about the customer it expresses.

## Recognition Mechanism

Why the intended customer may immediately recognize themselves in it.

## Brand Fit

How it expresses the approved positioning without weakening brand boundaries.
...
After selecting promising territories, generate concrete product concepts within them.

Concepts may include:

- slogans,
- phrases,
- typography-led executions,
- illustration-led executions,
...
> **Why would this specific person want to wear this rather than merely agree with it?**
...
A weak design result should first affect the design.

Repeated weak executions within a territory may affect the territory.
...
The Creative Director should distinguish:

- observed result,
- plausible creative interpretation,
...
Do not say “the niche failed” when the evidence only supports “this execution failed.”
...
**R012 — Antiques Treasure Hunters**
...
- concept-selection heuristics,
- visual-system guidance,
- creative quality standards,
- production-readiness criteria,
- creative testing patterns,
- internal benchmark libraries,
- negative-pattern libraries.

These should be added only when execution demonstrates that they are useful.
